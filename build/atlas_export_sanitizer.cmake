...
set( _fileName "${_fileName}HWWPhysicsxAODMakerConfig-targets-*.cmake" )
...
foreach( _element ${_targetsContent} )
   ...
   string( REGEX REPLACE
      "/[^ \"]*/AthAnalysisExternals/[^/]+/InstallArea/([^/]+)"
      "\$ENV{HWWPhysicsxAODMaker_DIR}/../../../../AthAnalysisExternals/\$ENV{AthAnalysisExternals_VERSION}/InstallArea/\\1"
      _newContent ${_newContent} )
