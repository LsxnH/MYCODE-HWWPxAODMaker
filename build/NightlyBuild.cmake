...
set( CTEST_SOURCE_DIRECTORY /home/hengli/testarea/HWWPxAODMaker/HWWPhysicsxAODMaker )
set( CTEST_BINARY_DIRECTORY /home/hengli/testarea/HWWPxAODMaker/build )
...
set( CTEST_SITE ui05.hep.ustc.edu.cn )

# Start a nightly build:
message( "Starting nightly build for project HWWPhysicsxAODMaker..." )
ctest_start( Nightly )
...
find_file( _buildExtractor NAMES extractCTestBuild.py
   PATH_SUFFIXES scripts PATHS /cvmfs/atlas.cern.ch/repo/sw/software/21.2/AthAnalysis/21.2.56/InstallArea/x86_64-slc6-gcc62-opt/cmake/modules;/cvmfs/atlas.cern.ch/repo/sw/software/21.2/AthAnalysisExternals/21.2.56/InstallArea/x86_64-slc6-gcc62-opt/cmake/modules )
...
set( _subprojects AsgTools;TriggerMatchingTool;GaudiKernel;xAODEgamma;xAODMuon;xAODEventInfo;xAODCaloEvent;xAODCore;xAODJet;xAODParticleEvent;xAODPrimitives;xAODBase;xAODBTagging;xAODMissingET;xAODTau;xAODTruth;xAODTracking;AthContainers;AthenaBaseComps;CxxUtils;AthAnalysisBaseComps;FourMomUtils;AtlasPolicy;AtlasROOT;AtlasBoost;JetCPInterfaces;JetCalibTools;JetResolution;JetInterface;JetJvtEfficiency;BoostedJetTaggers;METInterface;METUtilities;xAODBTaggingEfficiency;MuonEfficiencyCorrections;MuonMomentumCorrections;MuonSelectorTools;ElectronPhotonFourMomentumCorrection;ElectronEfficiencyCorrection;ElectronPhotonSelectorTools;PATInterfaces;PATCore;AssociationUtils;IsolationSelection;IsolationCorrections;AsgAnalysisInterfaces;JetAnalysisInterfaces;OverlapRemovalDefs;PhysicsxAODCode;HWWFakeFactorxAOD;HWWVHxAOD;HWWlnulnuxAODConfig;PhysicsxAODConfig;PMGAnalysisInterfaces;PMGTools;PathResolver;TruthWeightTools )
