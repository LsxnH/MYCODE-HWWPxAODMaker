...
OUTDIR=${DESTDIR}/usr/HWWPhysicsxAODMaker/1.0.0/InstallArea/x86_64-slc6-gcc62-opt
...
/cvmfs/atlas.cern.ch/repo/ATLASLocalRootBase/x86_64/Cmake/3.11.0/Linux-x86_64/bin/cmake -E copy /home/hengli/testarea/HWWPxAODMaker/build/x86_64-slc6-gcc62-opt/bin/*.dbg \
    ${OUTDIR}/bin/
/cvmfs/atlas.cern.ch/repo/ATLASLocalRootBase/x86_64/Cmake/3.11.0/Linux-x86_64/bin/cmake -E copy /home/hengli/testarea/HWWPxAODMaker/build/x86_64-slc6-gcc62-opt/lib/*.dbg \
    ${OUTDIR}/lib/
