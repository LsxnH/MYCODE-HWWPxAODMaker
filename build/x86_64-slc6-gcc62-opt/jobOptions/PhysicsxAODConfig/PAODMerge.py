...
#
#  Usage: This script is meant to (slow-) merge several PAODs into one PAOD.
#         It should also correctly merge all available meta data.
#         To run, type:
#              athena PhysicsxAODConfig/PAODMerge.py 2>&1 | tee log.txt
# =============================================================================
...
paodMsg = logging.getLogger('PAODMerge')
...
outFileName   = outStreamName+".merge.pool.root"
...
# ==============================================================================
#mgeisen: currently commented out due to compartibility problems with r21.2
